...
$con = mysqli_connect("localhost","root","","break1");
 ...
 echo "counts all the downliners under the user's downliners <br/>";
     if($level == 1){
    	if($count >= 1 && $count2 >= 1 && $count3 >= 1){
    		echo "yes";
    	}else{
    		echo "Must not be paid for Level 1";
    	}
    }else if($level == 2){
    	if($count >= 3 && $count2 >= 3 && $count3 >= 3){
    		echo "yes";
    	}else{
    		echo "Must not be paid for Level 2";
    	}
    }else if($level == 3){
    	if($count >= 12 && $count2 >= 12 && $count3 >= 12){
    		echo "yes";
    	}else{
    		echo "Must not be paid for Level 3";
    	}
    }else if($level == 4){
    	if($count >= 39 && $count2 >= 39 && $count3 >= 39){
    		echo "yes";
    	}else{
    		echo "Must not be paid for Level 4";
    	}
    }else if($level == 5){
    	if($count >= 120 && $count2 >= 120 && $count3 >= 120){
    		echo "yes";
    	}else{
    		echo "Must not be paid for Level 5";
    	}
    }
    else if($level == 6){
    	if($count >= 363 && $count2 >= 363 && $count3 >= 363){
    		...
    		echo "Must not be paid for Level 6";
    	}
    }
     else if($level == 7){
