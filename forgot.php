   ...
   <a href="index.php">
                    ...
                    <div class="col-md-3 col-lg-3">
                        <ul class="unstyled user">
                            <li class="sign-in"><a href="Login" style="color: white;" class="btn btn-primary"><i class="fa fa-user" style="color: white;"></i> sign in</a></li>
                            <li class="sign-up"><a href="signup" class="btn btn-primary"><i class="fa fa-user-plus"></i> register</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="site-nav-inner">
                        ...
                        <div class="collapse navbar-collapse navbar-responsive-collapse">
                            ...
                            <ul class="nav navbar-nav">
                                <li><a href="Welcome-To-PayProud">Home</a></li>
                                <li><a href="More-About-Payproud">About Us</a></li>
                                <li><a href="Welcome-To-PayProud#pricing">How To Invest</a></li>
                                <li><a href="Welcome-To-PayProud#call-action-al">Recruit Program</a></li>
...
<h2 class="text-center"> Forgot Account </h2>
...
<input type="email" name="lname" id="email" value="" class="required-field form-control">
<h5 class="text-center">If you have forgotten your password please enter your email address below and a new password will be emailed to you shortly.</h5>
</div>
...
<label class="input">
      <div class="g-recaptcha" style="margin: 0px auto;" data-sitekey="6LfpiJkUAAAAAL62YGNVfH5g8EPICchgrtI708nj" data-callback="verifyCaptcha"></div>
...
<div id="message"></div>
<button class="btn btn-success btn-block" id="login" name="Register" type="button" >Reset</button>
  ...
  $(function(){
    ...
    if(response.length == 0) { 
       $("#message").html("<div class='alert alert-warning'>Please verify you are human</div>");
         ...
         $.post("includes/reset.php", {email: email})
         .done(function(data){
            if(data == "Success"){
               $("#message").html("<div class='alert alert-success'>Thank You<br/>An email with a new password has been sent to your email address, if it exists in our system.</div>");
              
               
            }
          
            else if(data == "wrong"){
                $("#message").html("<div class='alert alert-warning'>Email doesn't exist</div>");
                
                 
               }else{
                 $("#message").html("<div class='alert alert-warning'>Ooops something went wrong, try again later</div>");
               }
